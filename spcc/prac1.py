...
#     print(line)
alp = ["START 100", "LOOP MOVER AREG, ='5'","LOOP MOVER AREG, ='5'", "ADD B", "STOP", "B DS 1", "END"]
symtab, littab, lc = {}, {}, 0
...
for line in alp:
    ...
    if "START" in words:
        ...
        littab[f"L{len(littab)}"] = (words[-1], lc)
        lc += 1
    elif words[0][-1] != ":" and words[0] not in ["STOP", "ADD", "MOVER", "END"]:
        symtab[words[0]] = lc
        lc += 1
